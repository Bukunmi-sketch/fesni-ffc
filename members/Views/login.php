...
<head>
  <title> Login to CCF-NIFES </title>
        ...
        <div class="login-details">
          <form action="#">
            ...
            <div class="email-details">
              <input type="text" name="memberid" placeholder="memberid" autofocus required>
            </div>
            ...
            <div class="password-details">
              ...
              <input type="password" id="pass" name="lastname" placeholder="Surname" required autocomplete="off">
            </div>
